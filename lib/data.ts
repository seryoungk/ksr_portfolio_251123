      ...
      projects: [
        {
          ...
          details: [
            ...
            // Marketo / 문의 기능
            "연속 클릭으로 인한 중복 다운로드 이슈를 방지하기 위해 다운로드 버튼 비활성화 UI를 설계하고 직접 개발했습니다.",
            "파일 첨부 시 Drag & Drop 및 파일 선택 창을 통해 업로드가 가능하도록 UI를 기획하고 디자인했으며, 개발까지 진행했습니다.",
            "파일 업로드 진행 상태를 사용자에게 보여주는 UI와 첨부된 파일 리스트를 확인할 수 있는 UI를 함께 구현했습니다.",
            "기업을 검색했을 때의 UI를 디자인하고 개발했습니다.",
            "체크박스 선택 가능한 개수를 제한하는 기능을 구현했습니다.",
            "필드 UI를 개선했으며, 필드를 클릭했을 때 자동으로 해당 위치로 스크롤되도록 하는 기능을 개발했습니다.",

            // 메인 / 콘텐츠 / 컴포넌트
            "메인 화면에 노출되는 팝업 컴포넌트를 개발했으며, 디자인 수정 단계부터 참여하여 UI 구현까지 함께 진행했습니다.",
            "웹사이트 메인 화면에 노출되는 뉴스 타입 컴포넌트를 개발했습니다.",
            "인재 채용 공고 페이지를 디자인하고 개발했습니다.",
            ...
            // 분석 / 디자인 시스템 / 협업
            "Claude를 활용해 LG CNS 디자인 시스템을 구축하고, 이를 기반으로 일관성 있는 UI 디자인을 진행했습니다.",
            "고객사(LG CNS)와 적극적으로 소통하며 다양한 디자인 시안을 제안했고, 제안한 시안이 실제 웹사이트에 반영되었습니다.",
          ],
        },
        {
          ...
          details: [
            ...
            "기존 컴포넌트를 수정하여, AEM 다이얼로그에서 텍스트 컬러를 변경하면 화면에 변경된 컬러가 적용된 텍스트가 노출되도록 개발했습니다.",
